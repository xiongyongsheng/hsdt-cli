...
function () {
  ...
  _createClass(Creator, [{
    ...
    value: function handleDirectory() {
      var targetDirectory, _ref, isOverwrite;

      return regeneratorRuntime.async(function handleDirectory$(_context2) {
        while (1) {
    ...
    value: function getCollectRepo() {
      var loading, _ref2, list, collectTemplateNameList, _ref3, choiceTemplateName;

      return regeneratorRuntime.async(function getCollectRepo$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 10:
              ...
              choiceTemplateName = _ref3.choiceTemplateName;
